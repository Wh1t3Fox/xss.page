    ...
    <div className="space-y-6">
              ...
              {question.options.map((option, oIndex) => {
                ...
                return (
                  <button
                    ...
                    disabled={submitted}
                    style={{ animationDelay: `${oIndex * 50}ms` }}
                    className={`w-full text-left p-4 rounded-lg border-2 transition-all animate-fadeInUp min-h-[56px] ${
                      submitted
                        ? showCorrectAnswer
      ...
      {!submitted ? (
        <button
          ...
          className="w-full bg-primary-600 text-white px-6 py-4 rounded-lg hover:bg-primary-700 disabled:bg-gray-300 disabled:cursor-not-allowed transition font-semibold text-lg flex items-center justify-center min-h-[56px]"
        >
          {isSubmitting ? (
            <>
